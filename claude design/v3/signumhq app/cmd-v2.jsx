  ...
  return (
    <div className="scroll" data-screen-label="Command v2">
      <header className="hdr glass cmd-bar">
        ...
        <div className="center"><div className="tk-row" style={{ justifyContent: 'center', gap: 7 }}><TickerIcon sym="NVDA" size={20}/><span className="tkr">NVDA</span></div><div className="co">NVIDIA Corp</div></div>
