...
$CompId = "MarketPressureBriefV36-SPY"
$InputVideo = "out/market_pressure_brief_v36_audio_caption_lock.mp4"
$OutputVideo = "out/market_pressure_brief_v36_audio_caption_lock_cbr.mp4"
...
Write-Host "======================================================================"
Write-Host "LAUNCHING SIGNUMHQ SHORTS ENGINE MISSION 43 V36 PIPELINE"
Write-Host "======================================================================"

Write-Host "`n1. REMOTION RENDER: rendering 536 frames..."
...
$silenceRaw | Out-File -FilePath "out/review/v36_silencedetect.txt" -Encoding utf8
...
$probeOutput | Out-File -FilePath "out/review/v36_ffprobe.json" -Encoding utf8
Write-Host $probeOutput

Write-Host "`n======================================================================"
Write-Host "5. STORYBOARD GENERATOR: Building contact sheet and audit logs..."
Write-Host "======================================================================"
node make-contact-sheet-v36.js

Write-Host "`n======================================================================"
Write-Host "MISSION 43 V36 RENDER & SSoT INTEGRITY VERIFICATION SUCCESSFUL!"
Write-Host "======================================================================"
