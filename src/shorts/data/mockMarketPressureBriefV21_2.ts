...
export const MOCK_V21_2_BEATS: ScriptBeat[] = [
...
export function createMockMarketPressureBriefV21_2Input(): ShortsVideoInput {
  return {
    videoId: `mock-market-pressure-v21-2-${Date.now()}`,
    template: 'MarketPressureBriefV21-2' as any,
    format: 'viral',
    ticker: 'SPY',
    title: 'Collision-Free V21.2 Upload Candidate',
    hook: 'SPY LOOKS NORMAL. THE FLOW DOESN\'T.',
    scriptBeats: MOCK_V21_2_BEATS,
    captions: [],
    dataCards: [],
    structureVisual: {
      price: 592.31,
    ...
    voice: { audioUrl: 'shorts/audio/v21_2_voice.mp3', durationSec: 17.5, provider: 'elevenlabs', isMock: false },
