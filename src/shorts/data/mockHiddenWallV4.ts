// ============================================================================
// Mock Hidden Wall V4 — 26s Visual Polish Cut
// Much stronger visual escalation. No dead seconds.
// ============================================================================
...
export const MOCK_V4_BEATS: ScriptBeat[] = [
...
export const MOCK_V4_CAPTIONS: CaptionSegment[] = []; // Not used for text on screen, the text components handle it directly.

export function createMockHiddenWallV4Input(): ShortsVideoInput {
  return {
    videoId: `mock-hidden-wall-v4-${Date.now()}`,
    template: 'HiddenWallShort',
    format: 'viral',
    ticker: 'SPY',
    title: 'The Wall Is Not On Your Chart',
    hook: 'THE WALL IS NOT ON YOUR CHART.',
    scriptBeats: MOCK_V4_BEATS,
    captions: MOCK_V4_CAPTIONS,
    dataCards: [],
    structureVisual: {
      price: 592.31,
      callWall: 600,
    ...
    // Using V4 Replicate B-roll (clean square/tall composition)
