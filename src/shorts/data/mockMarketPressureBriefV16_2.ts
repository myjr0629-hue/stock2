// Mock Market Pressure Brief V16.2 — Visual Authority Fix
import type { ShortsVideoInput, ScriptBeat } from '../types';

export const MOCK_V16_2_BEATS: ScriptBeat[] = [
...
export function createMockMarketPressureBriefV16_2Input(): ShortsVideoInput {
  return {
    videoId: `mock-market-pressure-v16-2-${Date.now()}`,
    template: 'MarketPressureBriefV16_2',
    format: 'viral',
    ticker: 'SPY',
    title: 'Market Pressure Brief V16.2 Visual Authority Fix',
    hook: 'SPY IS 1.3% BELOW A HIDDEN CALL WALL',
    scriptBeats: MOCK_V16_2_BEATS,
    captions: [],
    dataCards: [],
    structureVisual: {
      price: 592.31,
    ...
    voice: { audioUrl: 'shorts/audio/v16_1_voice.mp3', durationSec: 20.5, provider: 'elevenlabs', isMock: false },
