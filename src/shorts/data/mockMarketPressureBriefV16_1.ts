// ============================================================================
// Mock Market Pressure Brief V16.1 — Audio Truth Pass
// ============================================================================

import type { ShortsVideoInput, ScriptBeat } from '../types';

export const MOCK_V16_1_BEATS: ScriptBeat[] = [
...
export function createMockMarketPressureBriefV16_1Input(): ShortsVideoInput {
  return {
    videoId: `mock-market-pressure-v16-1-${Date.now()}`,
    template: 'MarketPressureBriefV16_1',
    format: 'viral',
    ticker: 'SPY',
    title: 'Market Pressure Brief V16.1 Audio Truth Pass',
    hook: 'SPY IS 1.3% BELOW A HIDDEN CALL WALL',
    scriptBeats: MOCK_V16_1_BEATS,
    captions: [],
    dataCards: [],
    structureVisual: {
      price: 592.31,
