...
export const MOCK_V21_1_BEATS: ScriptBeat[] = [
  { id: 'shock', label: 'hook', startSec: 0, endSec: 0.7, text: 'SPY LOOKS NORMAL. THE FLOW DOESN\'T.', emphasis: [] },
  { id: 'proof', label: 'proof', startSec: 0.7, endSec: 2.5, text: '$420M OFF-EXCHANGE NEAR THE $600 WALL', emphasis: [] },
...
export function createMockMarketPressureBriefV21_1Input(): ShortsVideoInput {
  return {
    videoId: `mock-market-pressure-v21-1-${Date.now()}`,
    template: 'MarketPressureBriefV21_1' as any,
    format: 'viral',
    ticker: 'SPY',
    title: 'Institutional Footprint V21.1 Surgical Fix',
    hook: 'SPY LOOKS NORMAL. THE FLOW DOESN\'T.',
    scriptBeats: MOCK_V21_1_BEATS,
    captions: [],
    dataCards: [],
    structureVisual: {
      price: 592.31,
    ...
    voice: { audioUrl: 'shorts/audio/v21_1_voice.mp3', durationSec: 17.5, provider: 'elevenlabs', isMock: false },
