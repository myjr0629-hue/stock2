    ...
    switch (action) {
      ...
      case 'education_pin': {
        ...
        if (pinCh) {
          ...
          // Use imageUrl from Redis content (already generated by daily-content, no EC2 call)
          const pinImage = content.en?.imageUrl || `${baseUrl}/templates/og/education?type=education&topic=${pinTopic}&lang=en&format=og`;
