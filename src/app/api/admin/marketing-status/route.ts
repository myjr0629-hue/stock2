...
const CRON_SCHEDULE = [
  ...
  { utc: '23:00', et: '19:00', kst: '08:00+1', action: 'briefing_thread', label: 'Briefing Thread → X Thread+Telegram', type: 'dispatch', region: 'ASIA', days: 'Mon-Fri' },
  ...
  { utc: '02:00', et: '22:00', kst: '11:00', action: 'edu_bsky', label: '📚 Education → Bluesky+Pinterest+Telegram', type: 'dispatch', region: 'EN', days: 'Mon-Sun' },
  ...
  { utc: '11:00', et: '07:00', kst: '20:00', action: 'briefing_thread', label: 'Briefing Thread → X Thread+Telegram(EN)', type: 'dispatch', region: 'EN', days: 'Mon-Fri' },
  ...
  // --- Weekend ---
  { utc: '14:00', et: '10:00', kst: '23:00', action: 'weekly_recap', label: '📊 주간 요약 Thread → X+Threads+Telegram', type: 'dispatch', region: 'ALL', days: 'Sat' },
