...
const TOPICS: Record<string, {
  ...
  iv_percentile: {
    title: 'IV Percentile',
    subtitle: 'Volatility Context Decoded',
    positiveLabel: '90TH PCTL',
    negativeLabel: '10TH PCTL',
    positiveCopy: 'Options more expensive\nthan 90% of the past year',
    negativeCopy: 'Options cheaper\nthan 90% of history',
    positiveIcon: 'M12 20V10M18 20V4M6 20v-4',
    negativeIcon: 'M22 12h-4l-3 9L9 3l-3 9H2',
    whyLine: 'Without IV context,\nyou\'re guessing if premiums are high or low.',
    cards: [
      'IV > 80th Pctl = Premiums elevated, selling favored',
      'IV 30-70th Pctl = Normal range, direction-dependent',
      'IV < 20th Pctl = Premiums cheap, buying opportunities',
    ],
    accentColor: '#fbbf24',
  },
  pcr: {
    ...
    positiveLabel: 'PCR > 1.0',
    negativeLabel: 'PCR < 0.7',
    positiveCopy: 'More puts purchased\n→ Fear is elevated',
    negativeCopy: 'More calls purchased\n→ Greed may be stretched',
    positiveIcon: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z',
    negativeIcon: 'M23 6l-9.5 9.5-5-5L1 18',
    whyLine: 'Extreme readings have historically\ncoincided with market turning points.',
    cards: [
      'PCR > 1.2 = Extreme fear, contrarian bounce zone',
      'PCR 0.7-1.0 = Balanced sentiment, trend-following',
      'PCR < 0.6 = Excessive greed, correction risk rising',
    ],
    accentColor: '#f87171',
  },
  max_pain: {
    title: 'Max Pain',
    subtitle: 'Options Expiration Gravity',
    positiveLabel: 'CALL WALL',
    negativeLabel: 'PUT FLOOR',
    positiveCopy: 'Highest call open interest\n→ Acts as ceiling resistance',
    negativeCopy: 'Highest put open interest\n→ Acts as floor support',
    positiveIcon: 'M12 2v20M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6',
    negativeIcon: 'M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4z',
    whyLine: 'Price doesn\'t move randomly.\nIt orbits around options structure.',
    cards: [
      'Price near Max Pain = Gravitational pull, range-bound',
      'Price above Call Wall = Breakout, gamma squeeze possible',
      'Price below Put Floor = Breakdown, dealer hedging amplifies',
    ],
    accentColor: '#22d3ee',
  },
};
