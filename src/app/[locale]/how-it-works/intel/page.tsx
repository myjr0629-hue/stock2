...
export default async function IntelGuidePage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    const sectors = [
        ...
        { key: 'orbitDefense', icon: <Rocket size={16} className="text-white" />, accent: 'from-sky-400 to-blue-600', tickers: ['LMT', 'RTX', 'AXON', 'SPCX', 'LDOS', 'ASTS', 'LUNR'], color: 'text-sky-400', ring: 'border-sky-500/20 bg-sky-500/[0.06]' },
