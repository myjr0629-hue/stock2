...
export const sections: TermsSection[] = [
    ...
    },
    {
        ...
        content: (
            <ol className="list-decimal list-inside space-y-3">
                ...
                <li><strong>市場データの出所および再配布の禁止：</strong> 場外（ダークプール）約定および空売りに関するデータは<strong>FINRA</strong>が所有・公表する規制報告資料であり、当社はこれを加工して表示しています。<strong>利用者は本サービスで提供される市場データを個人的・専門的な参考目的でのみ利用でき、第三者への再配布・転載または商業的転用はできません。</strong></li>
                ...
                <li><strong>非登録投資助言業者：</strong> 本サービスは、<strong>米国SEC、FINRAなどの金融規制機関に投資助言業者として登録されておらず、</strong>個別の投資助言またはそれに類するカスタマイズされたサービスを提供するものではありません。当社はデータ分析ソフトウェアの提供者です。</li>
    ...
    },
    {
        ...
        content: (
            <ol className="list-decimal list-inside space-y-2">
                <li>当社は有料サービス（Pro、Eliteなど）を提供し、各サブスクリプション等級別の利用範囲と料金はサービス内で別途告知します。</li>
    ...
    },
    {
        ...
        content: (
            <ol className="list-decimal list-inside space-y-2">
                <li>本規約の解釈および適用に関しては、<strong>米国デラウェア州の法律</strong>を準拠法とし、法の抵触に関する規定は適用しません。</li>
                <li>本規約に関連して発生した全ての紛争は、<strong>米国デラウェア州所在の州裁判所または連邦裁判所</strong>を第一審管轄裁判所とします。</li>
                <li>海外からサービスを利用する会員も、本規約に同意することにより、<strong>デラウェア州法律の適用およびデラウェア州裁判所の管轄に同意</strong>したものとみなされます。</li>
            </ol>
        ),
    },
];
