                                             ...
                                             <div className="p-5 rounded-2xl bg-[#0b101c]/60 border border-slate-800 backdrop-blur-md flex flex-col gap-4">
                                                 <h3 className="text-[13px] font-black tracking-widest text-white uppercase border-b border-slate-800/80 pb-3 flex items-center justify-between">
                                                     <span className="flex items-center gap-2">
                                                         <Sliders className="w-3.5 h-3.5 text-cyan-400" />
                                                         QUANT TRADING EXECUTION PLAYBOOK
                                                     </span>
                                                 ...
                                                 <div className="flex flex-col gap-5">
                                                                 ...
                                                                 trimsList.map(x => {
                                                                     ...
                                                                     return (
                                                                         <div key={x.ticker} className={`p-3.5 rounded-xl border transition-all flex flex-col gap-2 relative ${
                                                                             isDone ? 'bg-slate-950/20 border-slate-900 opacity-50' : 'bg-slate-950/60 border-slate-900 hover:border-slate-800'
                                                                         }`}>
                                                                             <div className="flex justify-between items-start">
                                                                                 <div className="flex items-center gap-2">
                                                                                     <span className="font-mono font-black text-white text-[14px] uppercase tracking-wider">{x.ticker}</span>
                                                                                     <span className="text-xs text-rose-400 bg-rose-500/10 px-1.5 py-0.5 rounded font-black border border-rose-500/20">
                                                                             ...
                                                                             <p className="text-[13px] text-slate-400 font-jakarta">
                                                                                 보유 수량을 <span className="font-bold text-slate-300 font-mono">{x.heldQty}주</span>에서 최적 목표치인 <span className="font-bold text-slate-300 font-mono">{x.targetShares}주</span>로 축소하여 즉시 현금을 확보하십시오.
                                                                             </p>
                                                                             <div className="flex justify-between items-center pt-2 border-t border-slate-900/60 mt-1">
                                                                                 <div className="font-mono text-[13px]">
                                                                                     <span className="text-slate-500">회수 가능 현금:</span> <span className="text-rose-400 font-bold">${refundCash.toLocaleString(undefined, {maximumFractionDigits:2})}</span>
                                                                                 </div>
                                                                                 <button 
                                                                                     onClick={() => {
                                                                                     ...
                                                                                     className="h-7 px-2.5 rounded bg-slate-900 border border-slate-800 hover:border-cyan-500/30 text-[11px] font-black text-cyan-400 hover:text-white transition-all uppercase tracking-wider flex items-center gap-1 font-mono"
                                                                                 >
                                                                     ...
                                                                     return (
                                                                         <div key={x.ticker} className={`p-3.5 rounded-xl border transition-all flex flex-col gap-2 relative ${
                                                                             ...
                                                                             <div className="flex justify-between items-start pr-16">
                                                                                 <div className="flex items-center gap-2">
                                                                                     <span className="font-mono font-black text-white text-[14px] uppercase tracking-wider">{x.ticker}</span>
                                                                                     <span className="text-xs text-emerald-400 bg-emerald-500/10 px-1.5 py-0.5 rounded font-black border border-emerald-500/20">
                                                                                         매수 +{x.diffQty}주
                                                                                     </span>
                                                                                 </div>
                                                                                 <button 
                                                                             ...
                                                                             <p className="text-[13px] text-slate-400 font-jakarta leading-normal">
                                                                             ...
                                                                             <div className="flex justify-between items-center pt-2 border-t border-slate-900/60 mt-1">
                                                                                 <div>
                                                                                     <span className="text-slate-500">필요 매수 자금:</span> <span className="text-emerald-400 font-bold">${orderCost.toLocaleString(undefined, {maximumFractionDigits:2})}</span>
                                                                                 </div>
                                                                                 <button 
                                                                                     onClick={() => {
                                                                                         const exec = (x.item as any).execution || {};
                                                     ...
                                                     <div className="flex flex-col gap-3 border-t border-slate-800/80 pt-4">
                                                         ...
                                                         <div className="flex flex-col gap-3">
                                                             {!hasHoldings ? (
                                                                 <div className="p-3 rounded-xl bg-slate-950/40 border border-slate-900 flex flex-col gap-3 font-jakarta">
                                                                     ...
                                                                     >
                                                                         ...
                                                                         최적 포트폴리오 일괄 구성 (BATCH BUY)
                                                                     </button>
                                                                 </div>
                                                             ) : (
                                                                 <>
                                                                     {/* Decay / Liquidation warning */}
                                                                     {decayPositions.length > 0 ? (
                                                                         <div className="p-3.5 rounded-xl bg-rose-950/20 border border-rose-500/20 flex flex-col gap-2">
                                                                             <div className="flex items-center gap-1.5 text-rose-400 font-bold text-[13px] uppercase tracking-wider font-mono">
                                                                             ...
                                                                             <button
                                                                                 ...
                                                                                 className="w-full h-9 rounded-xl bg-rose-500/20 hover:bg-rose-500/30 text-rose-400 border border-rose-500/30 font-black transition-all flex items-center justify-center gap-1.5 tracking-wider uppercase text-[13px]"
                                                                             >
                                                                                 {isInjecting ? (
                                                                     ...
                                                                     {lowestScoreHolding && highestScoreScanned && (highestScoreScanned.alphaSnapshot.score > (lowestScoreHolding.alphaScore || 0)) ? (
                                                                         <div className="p-3.5 rounded-xl bg-cyan-950/20 border border-cyan-500/20 flex flex-col gap-2 font-mono text-[13px]">
                                                                             ...
                                                                             <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-2 text-center bg-slate-950/40 p-2 rounded-lg border border-slate-900">
                                                                                 <div className="flex flex-col">
                                                                                     ...
                                                                                     <span className="text-[12px] text-slate-500">Score {lowestScoreHolding.alphaScore}</span>
                                                                                 </div>
                                                                                 <span className="text-slate-500 font-bold">➔</span>
                                                                                 <div className="flex flex-col">
                                                                                     <span className="text-emerald-400 font-bold">{highestScoreScanned.ticker}</span>
                                                                                     <span className="text-[12px] text-slate-500">Score {highestScoreScanned.alphaSnapshot.score}</span>
                                                                                 </div>
                                                                             </div>
                                                                             <p className="text-[13px] text-slate-400 leading-normal font-jakarta">
                                                                             ...
                                                                             <button
                                                                                 ...
                                                                                 disabled={isInjecting}
                                                                                 className="w-full h-9 rounded-xl bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-400 border border-cyan-500/30 font-black transition-all flex items-center justify-center gap-1.5 tracking-wider uppercase text-[13px]"
                                                                             >
                                                                                 {isInjecting ? (
