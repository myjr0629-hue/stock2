                        ...
                        <div className="col-span-12 lg:col-span-4 min-w-0 h-full">
                                <div className="flex flex-col gap-4 h-full">
                                    ...
                                    >
                                        ...
                                        {isMarketActive ? (
                                            <>
                                                <div className="max-h-[280px] overflow-y-auto pr-2 verdict-scroll mb-2">
                                    ...
                                    <div className="flex-1 border border-slate-800 rounded-lg p-3.5 md:p-4 lg:p-6 relative shadow-2xl flex flex-col overflow-hidden"
