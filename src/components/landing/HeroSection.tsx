            ...
            <div className="relative overflow-hidden rounded-2xl p-5 shadow-sm group hover:shadow-lg transition-all duration-300 h-[180px] flex flex-col justify-center">
                ...
                <div className="relative z-10 text-white">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-lg font-bold tracking-tight text-white font-jakarta">{t('insight.title')} <span className="text-blue-200 opacity-80 font-normal ml-1.5 text-xs">{t('insight.subtitle')}</span></h3>
                    </div>
            ...
            <div className="relative overflow-hidden rounded-2xl p-5 shadow-sm group hover:shadow-lg transition-all duration-300 h-[180px] flex flex-col justify-center">
                ...
                <div className="relative z-10 text-white">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-lg font-bold tracking-tight text-white font-jakarta">{t('velocity.title')} <span className="text-orange-200 opacity-80 font-normal ml-1.5 text-xs">{t('velocity.subtitle')}</span></h3>
                    </div>
