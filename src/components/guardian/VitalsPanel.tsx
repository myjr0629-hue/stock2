        ...
        <div className="w-full h-full flex flex-col justify-center gap-4">
            ...
            <div className="grid grid-cols-2 gap-4 border-b border-white/5 pb-3">
                ...
                <div>
                    ...
                    <div className="text-[12px] text-slate-500 font-mono font-jakarta">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <div className={`text-[12px] font-bold tracking-wider ${ndxRvol.color} font-jakarta`}>
                        [{ndxRvol.label}]
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className={`text-[12px] font-bold tracking-wider ${dowRvol.color} font-jakarta`}>
                        [{dowRvol.label}]
                    </div>
                </div>
            </div>
