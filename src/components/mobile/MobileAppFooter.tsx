...
/**
 * MobileAppFooter — Sleek, premium legal footer designed exclusively for mobile app-view screens.
 * Contains translation-enabled disclaimer, terms, privacy, refund, and contact details.
 */
export function MobileAppFooter() {
    ...
    return (
        <footer className="border-t border-white/[0.03] bg-[#050a14]/60 backdrop-blur-md px-5 pt-5 pb-8 mt-auto w-full">
            <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1.5 text-[11px] text-slate-400/80 mb-3.5 font-sans font-medium">
                ...
                <span className="text-slate-400">
                    {isKorean ? '문의' : isJapanese ? 'お問い合わせ' : 'Contact'}:{' '}
