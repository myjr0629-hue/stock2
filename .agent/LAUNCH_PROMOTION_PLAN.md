...
- **Premium+ 둘 다 가입** (사용자 확정 2026-07-11): X(en)·X(ja) 모두 **Premium+**, **웹(x.com)에서
  가입** (iOS 인앱 결제는 애플 수수료로 더 비쌈). 근거: 검증 데이터상 Premium+가 전 등급 중 최고
  도달(노출 중앙값 1,550+ vs 일반 Premium ~600) — 팔로워 0 신규 계정의 "도달 바닥 탈출"에 최적.
  버퍼 채널 정리로 뜨는 예산이 업그레이드분 상쇄. ⚠️ 수익화·긴영상·Grok상위는 지금 무용(덤).
  도달 수치는 상관관계라 인과 리프트는 그보다 작을 수 있음.
