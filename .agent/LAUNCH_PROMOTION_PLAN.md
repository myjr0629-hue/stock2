...
- **Premium 둘 다 가입** (사용자 확정): X(en)·X(ja) 모두 중간등급 Premium, **웹(x.com)에서 가입**
  (iOS 인앱 결제는 애플 수수료로 더 비쌈). Basic은 답글부스트 약해 부족, Premium+는 불필요.
- 순서: X(en) 개설→Premium→버퍼 연결 (지금) / X(ja)는 en 안착 2~3주 뒤 동일 절차.
