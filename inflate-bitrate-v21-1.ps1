...
$InputVideo = "out/market_pressure_brief_v21_1_upload_candidate.mp4"
$OutputVideo = "out/market_pressure_brief_v21_1_upload_candidate_cbr.mp4"
$FFmpegPath = "node_modules\@remotion\compositor-win32-x64-msvc\ffmpeg.exe"

Write-Host "Inflating V21.1 bitrate to 15Mbps CBR..."
