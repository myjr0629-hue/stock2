/**
 * Deploy Lambda v5.0 — Full Data Collection for Instant Command Page
 * 
 * Added over v4:
 * - SMA 50/200 for 300 tickers → signum-alpha-history (sma50, sma200 fields)
 * - Analyst consensus for 100 tickers → signum-pattern-db
 * - Earnings date for 100 tickers → signum-pattern-db  
 * - Fundamentals for 100 tickers → signum-pattern-db
 * - Related tickers for 100 tickers → signum-pattern-db
 * 
 * Schedule: 5-minute SMA batch (extends data freshness)
 *           Daily: Analyst/Earnings/Fundamentals/Related (rarely change)
 * 
 * Usage: node scripts/deploy-lambda-v5.js
 */
...
async function deploy() {
  ...
  console.log('✅ Lambda code updated: signum-harvest v5.0');
  ...
  console.log('✅ v5.0: 300 price + 100 GEX + SMA + Analyst + Earnings + Fund + RLSI + Alpha');
}
