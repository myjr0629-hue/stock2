...
async function run() {
    try {
        ...
        let outputText = parsed.content[0].text;
        ...
        try {
            ...
            console.log(aiJson.currentState.ko);
            console.log("\\n[기술적 구조 분석]");
            console.log(aiJson.sections[0].content.ko);
            console.log("\\n[옵션 포지셔닝]");
            console.log(aiJson.sections[1].content.ko);
            console.log("\\n[뉴스 및 시장 맥락]");
            console.log(aiJson.sections[2].content.ko);
            console.log("\\n[Key Insight]");
            console.log(aiJson.keyInsight.ko);
        } catch(e) {
