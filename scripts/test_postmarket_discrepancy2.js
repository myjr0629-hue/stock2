...
const url = `https://api.polygon.io/v2/aggs/ticker/AMD/range/1/minute/1771966800000/1771981200000?adjusted=true&sort=desc&limit=1000&apiKey=${process.env.POLYGON_API_KEY}`;
