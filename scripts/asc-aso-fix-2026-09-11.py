...
FIELDS = {
    "en-US": (
        ...
        "stocks,investing,ai,premarket,earnings,after hours,dark pool,unusual,gex,max pain,0dte,nvidia",
    ),
    "ko": (
        "SIGNUM HQ: AI 미국 주식 투자",
        "서학개미 미국증시 실적·옵션 흐름",
        "주식,주식어플,투자,ai,코스피,미국주식,미장,증시,시황,실적발표일정,기업실적,나스닥,테슬라,주가,무료,실시간,해외주식,종목분석,배당주,오늘의증시,증시캘린더,장마감,옵션,공시",
    ),
    "ja": (
        "SIGNUM HQ: 米国株リアルタイム決算",          # 변경 없음 — 米国株(2)가 이미 들어 있다
        "AI・株価アプリ・プレマーケット・決算",
        "株価,株式,株アプリ,ai,米国株,米国株アプリ,決算発表,決算カレンダー,テスラ,エヌビディア,ナスダック,個別株,銘柄,速報,市況,相場,出来高,需給,オプション,時間外取引,経済指標",
    ),
}
