...
const APPS = {
  signum: {
    ...
    copy: {
      // ★ 2026-09-16 대표 지시 «지표가 아니라 앱을 판다»: 첫 3장(dash·cmd·flow)이 무료·프리마켓·실적·평이한 말로 시작한다.
      ko: {
        dash: '미국 시장 전체를|무료 앱 하나로',
        cmd: '종목 하나, 전부 쉬운 말로|가격·옵션·다크풀',
        flow: '기관이 지금|무엇을 하는지',
        guardian: '시장 위험을|실시간으로',
        intel: '매일 마감 후|AI 시황 브리핑',
        heatmap: '10섹터 · 70종목|한눈에',
      },
      en: {
        dash: 'The whole US market,|free, on one screen',
        cmd: 'One ticker, in plain English|price · options · dark pool',
        flow: 'See what institutions|are doing right now',
        guardian: 'Market risk,|watched in real time',
        intel: 'An AI market brief,|every close',
        heatmap: '10 sectors · 70 tickers|at a glance',
      },
      ja: {
        dash: '米国市場のすべてを|無料アプリひとつで',
        cmd: '一銘柄を、やさしい言葉で|株価・オプション・ダークプール',
        flow: '機関投資家が今|何をしているか',
        guardian: '市場リスクを|リアルタイム監視',
        intel: '毎日引け後に|AI市況要約',
        heatmap: '10セクター・70銘柄|ひと目で',
      },
    },
