...
const url = `https://api.polygon.io/v2/aggs/ticker/AMD/range/1/minute/${d.getTime()}/${d2.getTime()}?adjusted=true&sort=desc&limit=1&apiKey=${process.env.POLYGON_API_KEY}`;
