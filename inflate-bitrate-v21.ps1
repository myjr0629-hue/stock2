...
$InputVideo = "out/market_pressure_brief_v21_institutional_footprint.mp4"
$OutputVideo = "out/market_pressure_brief_v21_institutional_footprint_cbr.mp4"
$FFmpegPath = "node_modules\@remotion\compositor-win32-x64-msvc\ffmpeg.exe"

Write-Host "Inflating V21 bitrate to 15Mbps CBR..."
