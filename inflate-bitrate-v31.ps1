...
$InputVideo = "out/market_pressure_brief_v31_event_shock_revenue_cut.mp4"
$OutputVideo = "out/market_pressure_brief_v31_event_shock_revenue_cut_cbr.mp4"
...
Write-Host "--- INFLATING V31 BITRATE TO 15MBPS CBR WITH FILLER ---"
...
$silenceRaw | Out-File -FilePath "out/review/v31_silencedetect.txt" -Encoding utf8
...
$probeOutput | Out-File -FilePath "out/review/v31_ffprobe.json" -Encoding utf8
$probeOutput

Write-Host "`n--- RUNNING STORYBOARD CONTACT SHEET GENERATOR ---"
node make-contact-sheet-v31.js
