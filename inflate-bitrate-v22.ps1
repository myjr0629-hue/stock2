...
$InputVideo = "out/market_pressure_brief_v22_event_first_revenue_cut.mp4"
$OutputVideo = "out/market_pressure_brief_v22_event_first_revenue_cut_cbr.mp4"
$FFmpegPath = "node_modules\@remotion\compositor-win32-x64-msvc\ffmpeg.exe"

Write-Host "Inflating V22 bitrate to 15Mbps CBR..."
