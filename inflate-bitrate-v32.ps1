...
$InputVideo = "out/market_pressure_brief_v32_first6_lock_rebuild.mp4"
$OutputVideo = "out/market_pressure_brief_v32_first6_lock_rebuild_cbr.mp4"
...
Write-Host "--- INFLATING V32 BITRATE TO 15MBPS CBR WITH FILLER ---"
...
$silenceRaw | Out-File -FilePath "out/review/v32_silencedetect.txt" -Encoding utf8
...
$probeOutput | Out-File -FilePath "out/review/v32_ffprobe.json" -Encoding utf8
$probeOutput

Write-Host "`n--- RUNNING STORYBOARD CONTACT SHEET GENERATOR ---"
node make-contact-sheet-v32.js
