...
$InputVideo = "out/market_pressure_brief_v19_true_upload_candidate.mp4"
$OutputVideo = "out/market_pressure_brief_v19_true_upload_candidate_cbr.mp4"
$FFmpegPath = "node_modules\@remotion\compositor-win32-x64-msvc\ffmpeg.exe"

Write-Host "Inflating bitrate to 15Mbps CBR..."

# Repackage video to force high bitrate using Constant Bitrate (CBR) and padding if necessary.
